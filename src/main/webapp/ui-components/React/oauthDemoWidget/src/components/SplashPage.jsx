...
import thinkhrLogo from '../../../../../images/pepcus.png';
...
class SplashPage extends Component {
  ...
  googleAuth() {
    ...
    function NewFile() {
      const param = {
        'response_type': 'code',
        'client_id': '559684630554-ia9pn44kek52tejcsohgo7q2aq4jb77n.apps.googleusercontent.com',
        'redirect_uri': "http://localhost:8383/pepcuscapability-showcase/",
